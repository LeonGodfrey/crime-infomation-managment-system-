                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" method="POST" action="send_oc.php">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <!-- text input -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <label>RSA legal feedback</label>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <a href="cases.php" class="btn btn-dark btn-flat">Back to Cases</a>
                                            </div>                                            
                                            <div class="col-sm-6">
                                            <div class="col-sm-6">                                                
                                                <button type="submit" class="btn btn-dark btn-flat" name="case">Submit feedback</button>
                                            </div>
