                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input type="text" class="form-control" name="name" value="<?php echo $io['name']; ?>" disabled>                                                                                                   
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="text" value="<?php echo $io['userCode']; ?>" disabled> 
                                                </div>
                                            </div>
                                        </div>
