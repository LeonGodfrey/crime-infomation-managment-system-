  ...
  <div class="col-12 col-sm-6 col-md-6">
    <a href="rsa_reviewed.php">
      <div class="info-box mb-3">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Investigated Cases</span>
          <span class="info-box-number">
            <?php
            $stmt = $conn->prepare("SELECT *, count(*) AS numrows FROM case_table WHERE status = :status AND pId = :pId");
            $stmt->execute(['status' => 'investigatedCase', 'pId' => $io['pId']]);
            $drow = $stmt->fetch();
