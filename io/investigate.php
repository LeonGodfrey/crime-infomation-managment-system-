                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Investigate</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2>Complaint RefNo.: <?php echo $row['refNo']; ?></h2>

                                </div>
                                <div class="card-body">
                                    <form class="form-horizontal" method="POST" action="investigate_save.php">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <!-- text input -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="pFindings" rows="3" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="iComment" value="" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <button type="submit" class="btn btn-dark btn-flat" name="complaint">Discard complaint</button>
                                            </div>                                            
                                            <div class="col-sm-6">
                                                <!-- text input -->
                                                <button type="submit" class="btn btn-dark btn-flat" name="case"><i class="fa fa-save"></i> Proceed to case</button>
                                            </div>
                                        </div>
                                </div>
